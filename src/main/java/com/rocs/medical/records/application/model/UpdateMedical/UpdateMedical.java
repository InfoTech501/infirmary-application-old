package com.rocs.medical.records.application.model.impl;
...
public class UpdateMedical {
    ...
    public UpdateMedical(int id, int studentId, int ailmentId, String medHistoryId, int nurseInChargeIn, String symptoms, int temperatureReadings, int visitDate, String treatment) {
        this.Id = id;
